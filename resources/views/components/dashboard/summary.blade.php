                ...
                <div class="p-3">
                    <div class="row">
                        <div class="col-9 col-lg-8 col-md-8 col-sm-9">
                            <div>
                                <h5 class="mb-0 text-capitalize font-weight-bold">
                                    ৳ <span id="todaysSale"></span>
                                </h5>
                                <p class="mb-0 text-sm">Todays Sale</p>
                            </div>
                        </div>
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 text-end">
                            <div class="icon icon-shape bg-gradient-primary shadow float-end border-radius-md">
...
<script>
    ...
    try {
        ...
        document.getElementById('todaysSale').innerText = data.todaysSale;
        document.getElementById('thisMonthSale').innerText = data.thisMonthSale;
